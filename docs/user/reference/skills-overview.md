...
| `changedoc`           | Per-change planning docs for existing repositories; product starts it, other roles enrich it, planner orchestrates. |
...
| `lazy`                | Engineer-first minimal-change implementation with safety guardrails.                                                |
...
| `simplify`            | Generic simplification of plans and proposals while preserving outcomes.                                            |
