...
class TestParserHelpers:
    ...
    def test_vscode_user_dir_none_when_missing(
        ...
        assert parser_module.CLIParser().vscode_user_dir() is None
...
class TestResolveTargets:
    ...
    def test_resolve_targets_default_uses_cwd_dot_github(
        ...
        assert parser_module.CLIParser().resolve_targets(args) == tmp_path / ".github"
    ...
    def test_resolve_targets_target_existing(self, tmp_path: Path) -> None:
        ...
        assert parser_module.CLIParser().resolve_targets(args) == target / ".github"
    ...
    def test_resolve_targets_target_missing_exits(self, tmp_path: Path) -> None:
        ...
        with pytest.raises(SystemExit) as exc:
            parser_module.CLIParser().resolve_targets(args)
    ...
    def test_resolve_targets_global_missing_exits(self, monkeypatch: pytest.MonkeyPatch) -> None:
        ...
        monkeypatch.setattr(parser_module.CLIParser, "vscode_user_dir", lambda self: None)
    ...
    def test_resolve_targets_global_returns_user_dir(
        ...
        monkeypatch.setattr(parser_module.CLIParser, "vscode_user_dir", lambda self: user_dir)
        args = argparse.Namespace(target=None, use_global=True)
        assert parser_module.CLIParser().resolve_targets(args) == user_dir
...
class TestBuildParser:
    ...
    def test_build_parser_has_expected_commands(self) -> None:
        ...
        parser = parser_module.CLIParser().build()
